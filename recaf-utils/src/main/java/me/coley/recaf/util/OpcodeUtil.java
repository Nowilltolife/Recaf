 ...
 * @author Matt Coley
 */
public class OpcodeUtil implements Opcodes, NonAbstractOpcodes {
	...
	/**
	 * Opcodes of {@link AbstractInsnNode#INSN} type.
	 */
	...
	public static int nameToOpcode(String name) throws NullPointerException {
		return nameToOpcode.get(name.toUpperCase());
	}
	...
	public static int nameToFrame(String name) throws NullPointerException {
		return nameToFrame.get(name.toUpperCase());
	}
	...
	public static int nameToTag(String tag) throws NullPointerException {
		return nameToTag.get(tag.toUpperCase());
	}
	...
	public static Set<String> getInsnSubset(String insnOpName) {
		insnOpName = insnOpName.toUpperCase();
	...
	static {
		...
		// Add index mappings
		indexedVarToIndex.put(NonAbstractOpcodes.ALOAD_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.ALOAD_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.ALOAD_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.ALOAD_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.ASTORE_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.ASTORE_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.ASTORE_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.ASTORE_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.DLOAD_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.DLOAD_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.DLOAD_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.DLOAD_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.DSTORE_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.DSTORE_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.DSTORE_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.DSTORE_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.FLOAD_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.FLOAD_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.FLOAD_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.FLOAD_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.FSTORE_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.FSTORE_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.FSTORE_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.FSTORE_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.ILOAD_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.ILOAD_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.ILOAD_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.ILOAD_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.ISTORE_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.ISTORE_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.ISTORE_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.ISTORE_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.LLOAD_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.LLOAD_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.LLOAD_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.LLOAD_3, 3);
		indexedVarToIndex.put(NonAbstractOpcodes.LSTORE_0, 0);
		indexedVarToIndex.put(NonAbstractOpcodes.LSTORE_1, 1);
		indexedVarToIndex.put(NonAbstractOpcodes.LSTORE_2, 2);
		indexedVarToIndex.put(NonAbstractOpcodes.LSTORE_3, 3);
	}
}
